    ...
    ui(new Ui::List)
{
    ...
    model->setHeaderData(3,Qt::Horizontal,tr("毛料"));
    model->setHeaderData(4,Qt::Horizontal,tr("时间"));
    model->setHeaderData(5,Qt::Horizontal,tr("成品"));
    model->setHeaderData(6,Qt::Horizontal,tr("时间"));
    model->setHeaderData(7,Qt::Horizontal,tr("日期"));
    model->setHeaderData(8,Qt::Horizontal,tr("出成"));
